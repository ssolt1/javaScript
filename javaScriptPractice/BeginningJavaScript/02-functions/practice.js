...
//     //=> 29.950000000000003
var totalCost = function (itemQuant, pricePerEach) {
	var preTaxTotal = itemQuant * pricePerEach;
	return preTaxTotal;
};
...
var closeTag = function (tagName) {
	var tagCloseNamed = "</" + tagName + ">";
	return tagCloseNamed;
};
